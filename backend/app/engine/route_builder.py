...
from app.core.config import config  # Import configuration for service URL and fuel settings
from app.core.logger import logger  # Import logging for surfacing integration errors
from app.ml.predictor import predictor  # Import ML engine for traffic congestion prediction
